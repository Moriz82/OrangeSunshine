...
public class CompoundExtractorRecipeCategory implements IRecipeCategory<CompoundExtractorRecipe> {

	public final static ResourceLocation UID = new ResourceLocation(OrangeSunshine.MOD_ID, "compound_extractor_crafting");
	public final static ResourceLocation TEXTURE = new ResourceLocation(OrangeSunshine.MOD_ID, "textures/gui/compound_extractor_gui.png");

	private final IDrawable background;
	private final IDrawable icon;
	//private final IDrawableStatic sun;

	public CompoundExtractorRecipeCategory(IGuiHelper helper) {
		this.background = helper.createDrawable(TEXTURE, 0, 0, 176, 85);
		this.icon = helper.createDrawableIngredient(new ItemStack(ModBlocks.COMPOUND_EXTRACTOR.get()));
	...
	@Override
	public Class<? extends CompoundExtractorRecipe> getRecipeClass() {
		return CompoundExtractorRecipe.class;
	}

	@Override
	public String getTitle() {
		return ModBlocks.COMPOUND_EXTRACTOR.get().getName().getString();
	}
	...
	@Override
	public void setIngredients(CompoundExtractorRecipe recipe, IIngredients ingredients) {
		ingredients.setInputIngredients(recipe.getIngredients());
		ingredients.setOutput(VanillaTypes.ITEM, recipe.getResultItem());
	}

	@Override
	public void setRecipe(IRecipeLayout recipeLayout, CompoundExtractorRecipe recipe, IIngredients ingredients) {
