...
public class DrugRegistry {
    ...
    public static final RegistryObject<Drug> LSD_BOTTLE = register("lsd_bottle", () -> new RedShrooms(new Drug.DrugProperties().adsr(2400F, 200F, 0.95F, 3000F)));
    public static final RegistryObject<Drug> LSD_BLOTTER = register("lsd_blotter", () -> new RedShrooms(new Drug.DrugProperties().adsr(2400F, 200F, 0.8F, 2400F)));
    public static final RegistryObject<Drug> ORANGESUNSHINE_BOTTLE = register("orangesunshine_bottle", () -> new RedShrooms(new Drug.DrugProperties().adsr(3100F, 300F, 0.66F, 3000F)));
    public static final RegistryObject<Drug> ORANGESUNSHINE_BLOTTER = register("orangesunshine_blotter", () -> new RedShrooms(new Drug.DrugProperties().adsr(3100F, 300F, 0.66F, 2400F)));
