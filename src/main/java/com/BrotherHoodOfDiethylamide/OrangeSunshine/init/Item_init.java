...
import com.BrotherHoodOfDiethylamide.OrangeSunshine.items.bases.tools.ToolSwordBase;
...
public class Item_init {
    ...
    public static final Item PSYCHSHOVEL = new ToolSwordBase("psych_shovel", PSYCHTOOLMATERIAL);
    public static final Item PSYCHHOE = new ToolSwordBase("psych_hoe", PSYCHTOOLMATERIAL);
    //-------------------------------- MISC
