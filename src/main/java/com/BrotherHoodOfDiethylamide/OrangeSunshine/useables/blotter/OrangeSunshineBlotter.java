package com.BrotherHoodOfDiethylamide.OrangeSunshine.useables.blotter;
...
public class OrangeSunshineBlotter extends ItemFood implements IHasModel {

    public OrangeSunshineBlotter(String name, int amount, float saturation, boolean isWolfFood) {
