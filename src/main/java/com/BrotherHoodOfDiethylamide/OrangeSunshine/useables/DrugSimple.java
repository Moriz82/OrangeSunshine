...
public class DrugSimple extends ItemFood implements Drug
{
    ...
    public DrugSimple(double decSpeed, double decSpeedPlus, int amount, float saturation, boolean isWolfFood)
    {
        this(decSpeed, decSpeedPlus, false, amount, saturation, isWolfFood);
    }

    public DrugSimple(double decSpeed, double decSpeedPlus, boolean invisible, int amount, float saturation, boolean isWolfFood)
    {
