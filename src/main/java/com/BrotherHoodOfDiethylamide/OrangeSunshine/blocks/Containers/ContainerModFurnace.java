package com.BrotherHoodOfDiethylamide.OrangeSunshine.blocks.Containers;
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (index == 2) {
                ...
                if (!Item_init.LSD.getDefaultInstance().isEmpty()) {
                    if (!this.mergeItemStack(itemstack1, 0, 1, false)) {
                        return ItemStack.EMPTY;
                    }
                } else if (TileEntityCompoundExtractor.isItemFuel(itemstack1)) {
