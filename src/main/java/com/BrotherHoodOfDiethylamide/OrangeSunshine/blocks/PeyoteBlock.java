...
public class PeyoteBlock extends CactusBlock {
	public PeyoteBlock(Properties p_i48435_1_) {
		super(p_i48435_1_);
	}
	...
	public boolean canSustainPlant(BlockState state, IBlockReader world, BlockPos pos, Direction facing, IPlantable plantable) {
		...
		if (plant.getBlock() == Blocks.CACTUS || plant.getBlock() == ModBlocks.PEYOTE_BLOCK.get())
			return state.is(Blocks.CACTUS) || state.is(Blocks.SAND) || state.is(Blocks.RED_SAND) || state.is(ModBlocks.PEYOTE_BLOCK.get());
