...
public class CompoundExtractorScreen extends ContainerScreen<CompoundExtractorContainer> {
    private final ResourceLocation GUI = new ResourceLocation(OrangeSunshine.MOD_ID,
            "textures/gui/compound_extractor_gui.png");

    public CompoundExtractorScreen(CompoundExtractorContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
