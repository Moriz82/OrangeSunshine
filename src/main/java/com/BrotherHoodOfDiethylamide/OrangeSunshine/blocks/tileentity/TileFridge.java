...
public class TileFridge extends TileEntityLockable implements ITickable {
    ...
    public void update() {
        ...
        for (int i = 0; i < INPUT_SLOTS; i++) {
            ...
            MachineRecipe recipe = MachineRecipeManager.findRecipe(MachineRecipeManager.FRIDGE, input);
    ...
    @Override public String getName() { return "container.fridge"; }
    @Override public boolean hasCustomName() { return false; }
    @Override public String getGuiID() { return "orangesunshine:fridge"; }
    @Override public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn) {
        return new com.BrotherHoodOfDiethylamide.OrangeSunshine.blocks.container.ContainerFridge(playerInventory, this);
    }
    ...
    public int getTotalTime(int slot) { return totalTimers[slot] > 0 ? totalTimers[slot] : 800; }
}
