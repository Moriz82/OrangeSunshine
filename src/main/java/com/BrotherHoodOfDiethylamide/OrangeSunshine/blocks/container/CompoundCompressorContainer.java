...
public class CompoundCompressorContainer extends Container {
    private final CompoundCompressorTile tileEntity;
    ...
    public CompoundCompressorContainer(int windowId, World world, BlockPos pos,
        ...
        super(ModContainers.COMPOUND_COMPRESSOR_CONTAINER.get(), windowId);
        this.tileEntity = (CompoundCompressorTile) world.getBlockEntity(pos);
        playerEntity = player;
