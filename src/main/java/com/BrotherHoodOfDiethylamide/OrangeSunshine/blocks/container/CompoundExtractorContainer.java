...
public class CompoundExtractorContainer extends Container {
    private final CompoundExtractorTile tileEntity;
    ...
    public CompoundExtractorContainer(int windowId, World world, BlockPos pos,
        ...
        super(ModContainers.COMPOUND_EXTRACTOR_CONTAINER.get(), windowId);
