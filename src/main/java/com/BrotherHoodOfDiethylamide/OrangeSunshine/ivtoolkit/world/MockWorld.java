...
package com.BrotherHoodOfDiethylamide.OrangeSunshine.ivtoolkit.world;

import com.BrotherHoodOfDiethylamide.OrangeSunshine.ivtoolkit.blocks.IvTileEntityHelper;
import com.BrotherHoodOfDiethylamide.OrangeSunshine.ivtoolkit.tools.IvWorldData;
...
/*
        @Override
        public FluidSt getFluidState(BlockPos pos)
        {
   ...
   /*     @Override
        public IBlockState getBlockState(@Nonnull BlockPos pos)
        {
            return worldData.blockCollection.block(pos);
        }*/
      ...
      /*  @Override
        ...
        public TileEntity getTileEntity(@Nonnull BlockPos pos)
        {
            for (NBTTagCompound nbt : worldData.tileEntities) {
                if (isAt(pos, nbt))
                    return TileEntity.create(Minecraft.getMinecraft().world, nbt);
            }
      ...
      /*  @Override
        public List<Entity> getEntities(AxisAlignedBB bounds, @Nullable Predicate<? super Entity> predicate)
        {
            return worldData.entities.stream()
                    ...
                    .map(nbt -> (nbt, Minecraft.getMinecraft().world))
                    .filter(predicate)
