...
package com.BrotherHoodOfDiethylamide.OrangeSunshine.ivtoolkit.transform;

import com.BrotherHoodOfDiethylamide.OrangeSunshine.ivtoolkit.blocks.Directions;
import com.BrotherHoodOfDiethylamide.OrangeSunshine.ivtoolkit.math.AxisAlignedTransform2D;
import com.BrotherHoodOfDiethylamide.OrangeSunshine.ivtoolkit.math.MinecraftTransforms;
import com.BrotherHoodOfDiethylamide.OrangeSunshine.ivtoolkit.tools.EntityCreatureAccessor;
...
public class PosTransformer
{
    ...
    public static void transformBlockDefault(AxisAlignedTransform2D transform, World world, IBlockState state, BlockPos coord, Block block)
    {
        ...
        for (IProperty<?> property : state.getPropertyKeys())
        {
            ...
            {
                EnumFacing value = (EnumFacing) state.getValue(property);
                newState = newState.withProperty((IProperty) property, transform.apply(value));
            }
        }
