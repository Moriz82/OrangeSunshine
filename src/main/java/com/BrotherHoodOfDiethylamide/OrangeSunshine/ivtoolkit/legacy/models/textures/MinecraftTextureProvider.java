...
public class MinecraftTextureProvider implements TextureProvider
{
    ...
    @Override
    public com.BrotherHoodOfDiethylamide.OrangeSunshine.ivtoolkit.legacy.models.textures.Texture provideTexture(String textureName)
    {
        return new Texture(new ResourceLocation(basePath + textureName));
    }

    public static class Texture implements com.BrotherHoodOfDiethylamide.OrangeSunshine.ivtoolkit.legacy.models.textures.Texture
    {
