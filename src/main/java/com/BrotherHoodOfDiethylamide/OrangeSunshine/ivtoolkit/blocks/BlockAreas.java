...
import com.BrotherHoodOfDiethylamide.OrangeSunshine.ivtoolkit.gui.IntegerRange;
...
public class BlockAreas
{
    ...
    {
        return BlockPos.getAllInBox(new BlockPos(area.getPoint1().getX(), area.getPoint1().getY(), area.getPoint1().getZ()), new BlockPos(area.getPoint2().getX(), area.getPoint2().getY(), area.getPoint2().getZ()));
    }

    public static Iterable<BlockPos.MutableBlockPos> mutablePositions(BlockArea area)
    {
        return BlockPos.getAllInBoxMutable(new BlockPos(area.getPoint1().getX(), area.getPoint1().getY(), area.getPoint1().getZ()), new BlockPos(area.getPoint2().getX(), area.getPoint2().getY(), area.getPoint2().getZ()));
    }

    public static Stream<BlockPos> streamPositions(BlockArea area)
    {
        return StreamSupport.stream(BlockPos.getAllInBox(new BlockPos(area.getPoint1().getX(), area.getPoint1().getY(), area.getPoint1().getZ()), new BlockPos(area.getPoint2().getX(), area.getPoint2().getY(), area.getPoint2().getZ())).spliterator(), false);
    }

    public static Stream<BlockPos.MutableBlockPos> streamMutablePositions(BlockArea area)
    {
        return StreamSupport.stream(BlockPos.getAllInBoxMutable(new BlockPos(area.getPoint1().getX(), area.getPoint1().getY(), area.getPoint1().getZ()), new BlockPos(area.getPoint2().getX(), area.getPoint2().getY(), area.getPoint2().getZ())).spliterator(), false);
    }
