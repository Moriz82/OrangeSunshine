...
import com.BrotherHoodOfDiethylamide.OrangeSunshine.ivtoolkit.math.IvBytePacker;
...
public class IvNBTHelper
{
    ...
    public static List<Double> readDoubleArray(String key, NBTTagCompound compound)
    {
    ...
    public static ArrayList<String> readNBTStrings(String id, NBTTagCompound compound)
    {
        if (compound.hasKey(id))
        {
            ...
            for (int i = 0; i < strings.size(); i++)
                strings.add(nbtTagList.getStringTagAt(i));
