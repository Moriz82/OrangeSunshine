...
public class RigItem extends Item implements IVanishable {
    public static final Object2ObjectFunction<Item, ModItems.DrugChain> RIGABLES = new Object2ObjectLinkedOpenHashMap<>();

    public RigItem(Item.Properties properties) {
        super(properties);
    }
    ...
    public ActionResult<ItemStack> use(World world, PlayerEntity playerEntity, Hand hand) {
        ...
        if (hand == Hand.MAIN_HAND && !itemStack.isEmpty() && itemStack.getDamageValue() < getMaxDamage(itemStack)) {
            ...
            if (!offhandItem.isEmpty()) {
                if (RIGABLES.containsKey(offhandItem.getItem())) {
    ...
    public ItemStack finishUsingItem(ItemStack itemStack, World world, LivingEntity entity) {
        if (entity instanceof PlayerEntity) {
            ...
            ModItems.DrugChain drugChain = RIGABLES.get(offhandItem.getItem());
