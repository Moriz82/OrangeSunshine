...
public class BongItem extends Item {
    public static final Map<Item, DrugItem.DrugEffectProperties[]> BONGABLES = new HashMap<>();

    public BongItem(String name) {
    ...
    public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand) {
        ...
        if (hand == EnumHand.MAIN_HAND && !itemStack.isEmpty() && itemStack.getItemDamage() < itemStack.getMaxDamage()) {
            ...
            if (!offhandItem.isEmpty() && BONGABLES.containsKey(offhandItem.getItem())) {
    ...
    public ItemStack onItemUseFinish(ItemStack stack, World world, EntityLivingBase entity) {
        if (entity instanceof EntityPlayer) {
            ...
            DrugItem.DrugEffectProperties[] effects = BONGABLES.get(offhandItem.getItem());
            if (effects != null) {
            ...
            world.playSound(player, player.getPosition(), ModSounds.JOINT_EXHALE, SoundCategory.PLAYERS, 1F, 1F);
        }
        return stack;
    }
