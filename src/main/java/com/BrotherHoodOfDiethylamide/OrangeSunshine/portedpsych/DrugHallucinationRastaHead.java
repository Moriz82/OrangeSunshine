...
public class DrugHallucinationRastaHead extends DrugHallucination
{
    ...
    public DrugHallucinationRastaHead(EntityPlayer playerEntity)
    {
        ...
        this.dummyEntity = new EntityPig(playerEntity.world);
...
//        this.chatBot = new ChatBotRastahead(playerEntity.getRNG(), playerEntity);
        ...
        rastaHeadTexture = new ResourceLocation(OrangeSunshine.MODID, OrangeSunshine.filePathTextures + "rastaHeadTexture.png");
    }
    ...
    public void update()
    {
        ...
        double totalDist = MathHelper.sqrt((wantedX - dummyEntity.posX) * (wantedX - dummyEntity.posX) + (wantedX - dummyEntity.posX) * (wantedX - dummyEntity.posX) + (wantedX - dummyEntity.posX) * (wantedX - dummyEntity.posX));
    ...
    public void render(float par1, float dAlpha)
    {
        ...
        if (alpha > 0.0f)
        {
            ...
            GL11.glTranslated(var3 - dummyEntity.posX, var5 + 1.0 - dummyEntity.posY, var7 - dummyEntity.posZ);
