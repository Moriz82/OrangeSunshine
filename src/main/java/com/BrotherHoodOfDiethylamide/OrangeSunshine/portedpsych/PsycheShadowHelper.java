...
//        GL11.glRotatef(90.0f, 0.0f, 1.0f, 0.0f);
    ...
    public static Matrix getSunMatrix()
    {
...
//        return IvMatrixHelper.getProjectionMatrix(0.4f, 1 / 1, getSunZNear(), getSunZFar());
    ...
    public static Matrix4f getSunViewMatrix()
    {
        ...
        float sunRadians = Minecraft.getMinecraft().world.getCelestialAngleRadians(1.0f);
    ...
    public static Matrix getInverseViewMatrix(float partialTicks)
    {
