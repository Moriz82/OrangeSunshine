...
public class MixingTableScreen extends HandledScreen<MixingTableScreenHandler> {
    private static final Identifier TEXTURE = OrangeSunshine.id("textures/gui/mixing_table.png");

    public MixingTableScreen(MixingTableScreenHandler handler, PlayerInventory inventory, Text title) {
