...
public class MortarPestleBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory, ImplementedInventory  {
    ...
    public ScreenHandler createMenu(int syncId, PlayerInventory playerInventory, PlayerEntity player) {
        return new MortarPestleScreenHandler(syncId, playerInventory, this, this.propertyDelegate);
    }
    ...
    private void craftItem() {
        Optional<RecipeEntry<MortarPestleRecipe>> recipe = getCurrentRecipe();
    ...
    private Optional<RecipeEntry<MortarPestleRecipe>> getCurrentRecipe() {
        SimpleInventory inv = new SimpleInventory(this.size());
        for(int i = 0; i < this.size(); i++) {
            inv.setStack(i, this.getStack(i));
        }

        return getWorld().getRecipeManager().getFirstMatch(MortarPestleRecipe.Type.INSTANCE, inv, getWorld());
    }
