...
public class MortarPestleRecipe implements Recipe<SimpleInventory> {
    ...
    public static class Serializer implements RecipeSerializer<MortarPestleRecipe> {
        ...
        public static final Codec<MortarPestleRecipe> CODEC = RecordCodecBuilder.create(in -> in.group(
                validateAmount(Ingredient.DISALLOW_EMPTY_CODEC, 9).fieldOf("ingredients").forGetter(MortarPestleRecipe::getIngredients),
                ItemStack.RECIPE_RESULT_CODEC.fieldOf("output").forGetter(r -> r.output)
        ).apply(in, MortarPestleRecipe::new));
        ...
        @Override
        public Codec<MortarPestleRecipe> codec() {
            return CODEC;
        }

        @Override
        public MortarPestleRecipe read(PacketByteBuf buf) {
            ...
            return new MortarPestleRecipe(inputs, output);
        }
